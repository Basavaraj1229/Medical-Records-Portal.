...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment appointment) {
		...
		try {
			...
			String sql = "insert into appointments(userId, fullName, gender, age, appointmentDate, email, phone, diseases, doctorId, address, status) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public boolean updateDrAppointmentCommentStatus(int apptId, int docId, String comment) {
		...
		try {
			...
			String sql = "update appointments set status=? where id=? and doctorId=?";
			PreparedStatement pstmt = this.conn.prepareStatement(sql);
